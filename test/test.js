...
describe('#configFile', () => {
  ...
  it('should have a Flickr object with all properties properly set', () => {
    ...
    expect(flickrObject).to.have.own.property('apiKey').to.be.a('string').to.not.be.empty;
    expect(flickrObject).to.have.own.property('apiSecret').to.be.a('string').to.not.be.empty;
    expect(flickrObject).to.have.own.property('accessToken').to.be.a('string').to.not.be.empty;
    expect(flickrObject).to.have.own.property('accessTokenSecret').to.be.a('string').to.not.be.empty;
  });

  it('should have a Wallpaper array', () => {
    expect(configFile).to.have.own.property('wallpapers').to.be.a('array').to.not.be.empty;
  });

  it('should have a Gallery array', () => {
    expect(configFile).to.have.own.property('galleries').to.be.a('array').to.not.be.empty;
  });
});
